...
Usage:
    python iam_key_age.py [filter_pattern]

    filter_pattern (optional) - regex pattern to filter usernames.
                                 Example: ".*-.*" to show only hyphenated names.
                                 For multiple substrings, use: "abc-xyz-com|obi-abc|xyz-com-users"

Output: Tabular list of all access keys (Active and Inactive) with age in days
        and last used date.
"""
